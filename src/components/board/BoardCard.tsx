...
const BoardCard: React.FC<Props> = ({ role, name, image, linkedin }) => {
  return (
    <motion.div
      ...
      className="bg-pse-purple-200 mt-5 flex w-[95%] max-w-96 flex-col items-center rounded-lg border-6 border-transparent p-4"
    >
      <div className="relative h-80 w-full max-w-80 overflow-hidden rounded-xl">
        <Image
