    ...
    <div className="mx-auto grid grid-cols-1 gap-[2vh] pb-[20vh] md:grid-cols-2 md:gap-[32vh] md:pb-[0vh]">
      <div className="relative order-2 h-[25vh] w-full scale-75 md:order-1 md:h-[65vh] md:scale-100">
        <Image
          src={ourmission}
          alt="ourmission"
          className="absolute right-[8vh] z-10 h-[57vh] w-full rounded-2xl object-cover md:right-[0vh]"
        />
        <div className="bg-pse-purple-300 absolute right-[-0vh] bottom-[-38vh] z-0 h-[35vh] w-[50vh] rounded-2xl md:right-[-8vh] md:bottom-[2vh]" />
        <div className="bg-pse-purple-200 absolute top-[3vh] -right-[8vh] z-10 h-[11vh] w-[22vh] rounded-2xl md:right-[-16vh]" />
      </div>
